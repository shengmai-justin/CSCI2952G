...
def main():
    ...
    student_model.load_state_dict(torch.load(args.stage1_model))
    ...
    for epoch in range(args.epochs):
        ...
        # Save checkpoint
        checkpoint_path = os.path.join(args.output_dir, f'checkpoint_stage2_epoch{epoch+1}.pt')
        torch.save({
            'epoch': epoch + 1,
    ...
    # Save final models
    student_model_path = os.path.join(args.output_dir, 'translatomer_cl_student.pt')
    teacher_model_path = os.path.join(args.output_dir, 'translatomer_cl_teacher.pt')
